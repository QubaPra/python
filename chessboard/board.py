...
class ChessBoard:
    ...
    def draw(self):
        ...
        for row in range(8):
            for col in range(8):
                if (row + col) % 2 == 0:
                    pygame.draw.rect(self.screen, self.board_color, [col * self.square_size, row * self.square_size, self.square_size, self.square_size])
                else:
                    pygame.draw.rect(self.screen, self.background_color, [col * self.square_size, row * self.square_size, self.square_size, self.square_size])     
